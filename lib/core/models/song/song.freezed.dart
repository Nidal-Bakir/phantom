...
class _$_Song implements _Song {
  ...
  @override
  String toString() {
    return 'Song(id: $id, absolutePath: $absolutePath, uri: $uri, displayName: $displayName, displayNameWOExt: $displayNameWOExt, size: $size, album: $album, albumId: $albumId, artist: $artist, artistId: $artistId, bookmark: $bookmark, composer: $composer, dateAdded: $dateAdded, dateModified: $dateModified, title: $title, fileExtension: $fileExtension)';
  }
...
abstract class _Song implements Song {
  const factory _Song(
      ...
      @JsonKey(name: 'title')
          required String title,
      @JsonKey(name: 'file_extension')
          required String fileExtension}) = _$_Song;
