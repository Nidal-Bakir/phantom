...
_$_Song _$$_SongFromJson(Map<String, dynamic> json) => _$_Song(
      ...
      songDuration: json['duration'] as int?,
      bookmark: json['bookmark'] as int?,
      composer: json['composer'] as String?,
      dateAdded: _addedDateFromMap(json['date_added'] as int),
      dateModified: _modifiedDateFromMap(json['date_modified'] as int?),
...
Map<String, dynamic> _$$_SongToJson(_$_Song instance) => <String, dynamic>{
      ...
      'duration': instance.songDuration,
      'bookmark': instance.bookmark,
      'composer': instance.composer,
      'date_added': _addedDateToMap(instance.dateAdded),
      'date_modified': _modifiedDateToMap(instance.dateModified),
